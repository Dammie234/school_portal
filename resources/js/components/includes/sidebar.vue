        ...
        >
          ...
          <ul class="md:flex-col md:min-w-full flex flex-col list-none">
            ...
            <li class="items-center" v-if="user.role == 1">
              <router-link
                to="/lecturer-courses"
                v-if="active && active == 'lecturer-courses'"
                class="text-xs uppercase py-3 font-bold block text-pink-500 hover:text-pink-600"
              >
                <i class="fas fa-user mr-2 text-sm text-blueGray-300"></i>
                Lecturer Courses
            ...
            <li class="items-center" v-if="user.role == 2">
              <router-link
                ...
                v-if="active && active == 'lecture-materials'"
                class="text-xs uppercase py-3 font-bold block text-pink-500 hover:text-pink-600"
              >
                <i class="fas fa-user mr-2 text-sm text-blueGray-300"></i>
                Lecturer Materials
            ...
            <li class="items-center" v-if="user.role == 3">
              <router-link
                to="/student/courses"
                v-if="active && active == 'student-courses'"
                class="text-xs uppercase py-3 font-bold block text-pink-500 hover:text-pink-600"
              >
                <i class="fas fa-user mr-2 text-sm text-blueGray-300"></i>
                My Courses
