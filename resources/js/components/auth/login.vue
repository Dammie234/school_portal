            ...
            <div class="w-full lg:w-4/12 px-4">
              ...
              >
                <div class="rounded-t mb-0 px-6 py-6">
                  <div class="text-center mb-3">
                    <h6 class="text-blueGray-500 text-xl font-bold">Sign in</h6>
                    <div v-if="error">
                      <div
                        class="w-full bg-red-500 text-white py-2"
                ...
                <div class="flex-auto px-4 lg:px-10 py-10 pt-0">
                  <form @submit.prevent="login">
                    ...
                    <div class="text-center mt-6">
                      ...
                      <p class="mt-3">
                        Don't have an account as a student
                        <router-link :to="{ name: 'student-register' }"
              ...
              <div class="flex flex-wrap mt-6">
                ...
                <div class="w-1/2 text-right">
                  <router-link to="/student-register" class="text-blueGray-200"
